...
public enum ChangeDetector {
    ...
    public struct Known: Equatable, Sendable {
        ...
        public init(size: Int64, mtime: Double, sha256: String, isSynced: Bool) {
            self.size = size
            self.mtime = mtime
            self.sha256 = sha256
    ...
    public enum PreDecision: Equatable, Sendable {
    ...
    public static func preDecision(
        known: Known?,
        size: Int64,
        mtime: Double,
    ...
    public enum PostHashDecision: Equatable, Sendable {
    ...
    public static func postHash(knownSha: String, computedSha: String?) -> PostHashDecision {
    ...
    public static func reconcileIsNoop(
        known: Known?,
        localSize: Int64,
        localMtime: Double,
        knownEtag: String,

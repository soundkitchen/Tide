...
public enum HardcodedIgnoreRules {
    ...
    public static let prefixPatterns: [String] = [
    ...
    public static let suffixPatterns: [String] = [
        ".pem",
        ".key",
        ".p12",
        ".pfx",
    ...
    public static func shouldIgnore(relativePath: String) -> Bool {

...
public struct TokenBucket: Sendable {
    ...
    public mutating func reserve(_ n: Double, now: Double) -> Double {
    ...
    public mutating func setRate(_ newRatePerSec: Double, now: Double) {
...
public actor RateLimiter {
    ...
    public var ratePerSec: Double { bucket.ratePerSec }

    /// レートを更新する（bytes/sec、`<= 0` で無制限）。
    public func setRate(_ ratePerSec: Double) {
    ...
    public func acquire(_ n: Int) async {

...
enum RestoreDestination: Equatable, Sendable {
    case writeOriginal
    case divertToCopy
}
...
enum RestoreTarget {
    ...
    static func decide(localExists: Bool, localSha: String?, dbRecordSha: String?) -> RestoreDestination {
...
protocol VersionedObjectClient: Sendable {
...
struct RestoreService {
    let client: any VersionedObjectClient
    ...
    @discardableResult
    func restore(relativePath: String, versionId: String?) async throws -> RestoreResult {

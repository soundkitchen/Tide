...
enum DeletedFilesCache {
    ...
    static func validate(_ payload: Payload, bucket: String) -> Payload? {
    ...
    static func load(bucket: String) -> Payload? {
    ...
    static func save(files: [FileVersionHistory], bucket: String, updatedAt: Date) throws {
        let payload = Payload(
